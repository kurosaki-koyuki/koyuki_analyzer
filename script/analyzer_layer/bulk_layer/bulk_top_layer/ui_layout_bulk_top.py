...
class BulkTopPageUI:
    ...
    def update_styles(self):
        ...
        for child in self.bulk_top_page.findChildren(QSlider):
    ...
    def create_page(self):
        ...
        self.btn_back_bulk = create_styled_button("← 返回主页", font_size=12)
        top_layout.addWidget(self.btn_back_bulk)
        ...
        self.btn_cox = create_styled_button("Cox分析", font_size=btn_font_size, parent=col3)
        col3_layout.addWidget(self.btn_cox, alignment=Qt.AlignCenter)
