...
from script.analyzer_layer.scRNAseq_layer.sc_hdwgcna_layer.sc_hdwgcna_analysis import get_sc_hdwgcna_analysis
from script.analyzer_layer.scRNAseq_layer.sc_hdwgcna_layer.ui_func_sc_hdwgcna import ScHdWgcnaFunc
from script.analyzer_layer.scRNAseq_layer.sc_hdwgcna_layer.sc_hdwgcna_worker import HdWgcnaWorker
...
class ScHdWgcnaBind:
    ...
    def bind_navigation(self):
        if hasattr(self.sc_hdwgcna_ui, 'btn_back_sc_hdwgcna'):
            self.sc_hdwgcna_ui.btn_back_sc_hdwgcna.clicked.connect(lambda: page_intersect.go_to_page_with_bind('scRNAseq_top_page'))
