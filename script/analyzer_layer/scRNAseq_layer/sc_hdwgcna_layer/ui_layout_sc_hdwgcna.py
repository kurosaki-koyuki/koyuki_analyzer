...
class ScHdWgcnaPageUI:
    ...
    def create_page(self):
        ...
        self.btn_back_sc_hdwgcna = create_styled_button("← 返回上一页", font_size=12)
        top_layout.addWidget(self.btn_back_sc_hdwgcna)
        ...
        # ================ 左侧参数面板 ================
        left_panel, left_layout = create_styled_panel(parent=overlay)
