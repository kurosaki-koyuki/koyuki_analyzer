# -*- coding: utf-8 -*-
"""
自定义气泡图界面UI布局脚本 - 只负责创建控件、规划窗口布局、摆放按钮/输入框/画布、设置样式尺寸
完全不写按钮点击、触发逻辑
"""
...
class ScTargetgeneBubblePageUI:
    ...
    def update_background(self):
        ...
        paths = get_mod_paths()
        bg_label = self.targetgene_bubble_page.findChild(QLabel, "targetgene_bubble_bg")
        if bg_label:
    ...
    def update_styles(self):
        ...
        title_label = self.targetgene_bubble_page.findChild(QLabel, "targetgene_bubble_title")
        if title_label:
        ...
        for child in self.targetgene_bubble_page.findChildren(QPushButton):
        ...
        for child in self.targetgene_bubble_page.findChildren(QComboBox):
            child.setStyleSheet(combo_style)

        line_edit_style = get_stylesheet_for_widget('line_edit')
        for child in self.targetgene_bubble_page.findChildren(QLineEdit):
            child.setStyleSheet(line_edit_style)

        text_edit_style = get_stylesheet_for_widget('text_edit')
        for child in self.targetgene_bubble_page.findChildren(QTextEdit):
            child.setStyleSheet(text_edit_style)

        label_style = get_stylesheet_for_widget('label')
        for child in self.targetgene_bubble_page.findChildren(QLabel):
            if child.objectName() != "targetgene_bubble_title" and not child.objectName().startswith("styled_image_label"):
                child.setStyleSheet(label_style)

        checkbox_style = get_stylesheet_for_widget('checkbox')
        for child in self.targetgene_bubble_page.findChildren(QCheckBox):
        ...
        """
        for child in self.targetgene_bubble_page.findChildren(QWidget):
            if child.objectName() and child.objectName().startswith("styled_panel"):
                child.setStyleSheet(panel_style)

        overlay = self.targetgene_bubble_page.findChild(QWidget, "targetgene_bubble_overlay")
        if overlay:
            overlay.setStyleSheet(f"background: {styles.get('overlay_background', 'rgba(0,0,0,0.3)')};")

    def create_page(self):
        self.targetgene_bubble_page = QWidget(self.parent)

        styles = get_mod_styles()
        paths = get_mod_paths()

        bg_label = QLabel(self.targetgene_bubble_page)
        bg_label.setObjectName("targetgene_bubble_bg")
        ...
        overlay = QWidget(self.targetgene_bubble_page)
        overlay.setObjectName("targetgene_bubble_overlay")
        ...
        title_label.setObjectName("targetgene_bubble_title")
        ...
        self.music_controller = MusicControllerClass(self.targetgene_bubble_page, mod_instance)
        ...
        self.targetgene_bubble_log = create_styled_text_edit(read_only=True, variant='sub')
        self.targetgene_bubble_log.setMaximumHeight(80)
        layout.addWidget(self.targetgene_bubble_log)
        ...
        self.targetgene_text_input = create_styled_text_edit(variant='sub')
        self.targetgene_text_input.setPlaceholderText("请输入基因列表，每行一个基因")
        self.targetgene_text_input.setMaximumHeight(120)
        gene_input_layout.addWidget(self.targetgene_text_input)
        ...
        x_anno_label = create_styled_label("X轴主注释", font_size=12, bold=True)
        left_layout.addWidget(x_anno_label)

        self.targetgene_bubble_x_combo = create_styled_combo_box()
        left_layout.addWidget(self.targetgene_bubble_x_combo)

        self.targetgene_bubble_x_list = create_styled_list_widget(fixed_height=100, multi_selection=True)
        left_layout.addWidget(self.targetgene_bubble_x_list)

        left_layout.addSpacing(10)

        y_anno_label = create_styled_label("Y轴主注释", font_size=12, bold=True)
        left_layout.addWidget(y_anno_label)

        self.targetgene_bubble_y_combo = create_styled_combo_box()
        left_layout.addWidget(self.targetgene_bubble_y_combo)

        self.targetgene_bubble_y_list = create_styled_list_widget(fixed_height=100, multi_selection=True)
        left_layout.addWidget(self.targetgene_bubble_y_list)
        ...
        self.targetgene_bubble_filter1_enable = create_styled_checkbox("启用筛选1")
        filter1_header.addWidget(self.targetgene_bubble_filter1_enable)
        ...
        self.targetgene_bubble_filter1_combo = create_styled_combo_box()
        self.targetgene_bubble_filter1_combo.setEnabled(False)
        filter1_layout.addWidget(self.targetgene_bubble_filter1_combo)

        filter1_group_label = create_styled_label("筛选组别1（可多选）", font_size=11, bold=False)
        filter1_layout.addWidget(filter1_group_label)

        self.targetgene_bubble_filter1_list = create_styled_list_widget(fixed_height=80, multi_selection=True)
        self.targetgene_bubble_filter1_list.setEnabled(False)
        filter1_layout.addWidget(self.targetgene_bubble_filter1_list)
        ...
        self.targetgene_bubble_filter2_enable = create_styled_checkbox("启用筛选2")
        filter2_header.addWidget(self.targetgene_bubble_filter2_enable)
        ...
        self.targetgene_bubble_filter2_combo = create_styled_combo_box()
        self.targetgene_bubble_filter2_combo.setEnabled(False)
        filter2_layout.addWidget(self.targetgene_bubble_filter2_combo)

        filter2_group_label = create_styled_label("筛选组别2（可多选）", font_size=11, bold=False)
        filter2_layout.addWidget(filter2_group_label)

        self.targetgene_bubble_filter2_list = create_styled_list_widget(fixed_height=80, multi_selection=True)
        self.targetgene_bubble_filter2_list.setEnabled(False)
        filter2_layout.addWidget(self.targetgene_bubble_filter2_list)
        ...
        self.targetgene_bubble_main_title = create_styled_line_edit(fixed_width=160)
        self.targetgene_bubble_main_title.setText("Target Gene Expression Bubble Plot")
        main_title_layout.addWidget(self.targetgene_bubble_main_title)
        ...
        self.targetgene_bubble_cbar_label = create_styled_line_edit(fixed_width=160)
        self.targetgene_bubble_cbar_label.setText("Mean Expression")
        cbar_label_layout.addWidget(self.targetgene_bubble_cbar_label)
        ...
        self.targetgene_bubble_fig_width = create_styled_spinbox(min_value=1, max_value=100, default_value=9)
        fig_width_layout.addWidget(self.targetgene_bubble_fig_width)
        ...
        self.targetgene_bubble_fig_height = create_styled_spinbox(min_value=1, max_value=100, default_value=7)
        fig_height_layout.addWidget(self.targetgene_bubble_fig_height)
        ...
        self.targetgene_bubble_scale_factor = create_styled_spinbox(min_value=100, max_value=2000, default_value=750)
        scale_factor_layout.addWidget(self.targetgene_bubble_scale_factor)
        ...
        self.targetgene_bubble_legend_scale = create_styled_spinbox(min_value=10, max_value=30, default_value=10)
        legend_scale_layout.addWidget(self.targetgene_bubble_legend_scale)
        ...
        self.targetgene_bubble_title_fontsize = create_styled_spinbox(min_value=8, max_value=30, default_value=14)
        title_fontsize_layout.addWidget(self.targetgene_bubble_title_fontsize)
        ...
        self.targetgene_bubble_x_label_fontsize = create_styled_spinbox(min_value=8, max_value=30, default_value=12)
        x_label_fontsize_layout.addWidget(self.targetgene_bubble_x_label_fontsize)
        ...
        self.targetgene_bubble_y_label_fontsize = create_styled_spinbox(min_value=8, max_value=30, default_value=12)
        y_label_fontsize_layout.addWidget(self.targetgene_bubble_y_label_fontsize)
        ...
        self.targetgene_bubble_legend_label_fontsize = create_styled_spinbox(min_value=6, max_value=20, default_value=10)
        legend_label_fontsize_layout.addWidget(self.targetgene_bubble_legend_label_fontsize)
        ...
        self.targetgene_bubble_cbar_label_fontsize = create_styled_spinbox(min_value=6, max_value=20, default_value=10)
        cbar_label_fontsize_layout.addWidget(self.targetgene_bubble_cbar_label_fontsize)
        ...
        self.targetgene_bubble_label_spacing = create_styled_spinbox(min_value=10, max_value=50, default_value=25)
        label_spacing_layout.addWidget(self.targetgene_bubble_label_spacing)
        ...
        self.targetgene_bubble_main_right_ratio = create_styled_spinbox(min_value=50, max_value=90, default_value=65)
        main_right_ratio_layout.addWidget(self.targetgene_bubble_main_right_ratio)
        ...
        self.targetgene_bubble_export_width = create_styled_spinbox(min_value=1, max_value=100, default_value=9)
        width_row.addWidget(self.targetgene_bubble_export_width)
        ...
        self.targetgene_bubble_export_height = create_styled_spinbox(min_value=1, max_value=100, default_value=7)
        height_row.addWidget(self.targetgene_bubble_export_height)
        ...
        self.targetgene_bubble_plot_tabs = create_styled_tab_widget()

        _, self.targetgene_bubble_image_label = create_styled_image_tab(self.targetgene_bubble_plot_tabs, "自定义气泡图")

        right_layout.addWidget(self.targetgene_bubble_plot_tabs)
...
__all__ = ['ScTargetgeneBubblePageUI']