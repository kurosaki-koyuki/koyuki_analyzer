# -*- coding: utf-8 -*-
"""
UMAP初步作图界面UI布局脚本 - 主层容器，管理Python/R版本切换
"""
...
class ScUmapInitialPageUI:
    ...
    def update_background(self):
        ...
        paths = get_mod_paths()
        bg_label = self.sc_umap_initial_page.findChild(QLabel, "sc_umap_initial_bg")
        if bg_label:
    ...
    def update_styles(self):
        ...
        overlay = self.sc_umap_initial_page.findChild(QWidget, "sc_umap_initial_overlay")
        if overlay:
    ...
    def create_page(self):
        self.sc_umap_initial_page = QWidget(self.parent)

        styles = get_mod_styles()
        paths = get_mod_paths()

        bg_label = QLabel(self.sc_umap_initial_page)
        bg_label.setObjectName("sc_umap_initial_bg")
        ...
        overlay = QWidget(self.sc_umap_initial_page)
        overlay.setObjectName("sc_umap_initial_overlay")
        ...
        return self.sc_umap_initial_page